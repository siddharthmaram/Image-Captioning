...
def language_eval(dataset, preds, model_id, split):
    ...
    if 'coco' in dataset:
        ...
        annFile = '/home/sri/AoANet_final/AoANet/bio_coco_format.json'
...
def eval_split(model, crit, loader, eval_kwargs={}):
    ...
    while True:
        ...
        # print(f"Evaluating: n={n}, batch size={loader.batch_size}, predictions so far={len(predictions)}")
        # print(f"Batch image IDs: {[info['id'] for info in data['infos']]}")
        ...
        # print("Prediction counts per image (top 10):")
        # for image_id, count in image_id_counter.most_common(10):
        #     print(f"Image ID {image_id} -> {count} predictions")

        # print(len(predictions))
        # print(f'Target num_images: {num_images}')
